...
There's a problem. Rafael Hernández Airport, with BQN code, does exist in the `flights` dataframe, but it is not listed in `airports` dataframe. Therefore, we have to add manually a row in `airports` indicating BQN airport.
